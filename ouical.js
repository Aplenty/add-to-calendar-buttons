;(function(exports) {
        ...
        var calendarGenerators = {
            google: function(event) {
                ...
                var el = document.getElementById('calendarGoogle');
                if (el) {
                    el.href= links.google;
                }

                return '<a class="icon-google" target="_blank" href="' +
                    links.google + '">Google Calendar</a>';
            },
            ...
            yahoo: function(event) {
                ...
                var el = document.getElementById('calendarYahoo');
                if (el) {
                    el.href= links.yahoo;
                }

                return '<a class="icon-yahoo" target="_blank" href="' +
                    links.yahoo + '">Yahoo! Calendar</a>';
            },
            ...
            ics: function(event, eClass, calendarName) {
                ...
                return '<a class="' + eClass + '" target="_blank" href="' +
                    links.ics + '">' + calendarName + ' Calendar</a>';
            },
            ...
            outlook: function(event) {
                var a = this.ics(event, 'icon-outlook', 'Outlook');
                var el = document.getElementById('calendarOutlook');
                if (el) {
                    el.href= links.ics;
                }
                return a;
